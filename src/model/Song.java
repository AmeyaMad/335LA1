...
public class Song {
    ...
    // this function allows us to set the stars for a song while keeping
    // encapsulation
    // @pre stars != null
    ...
    // not sure if this is needed, will check later but when I looked online for why
    // things are not removing it said
    // equals and hashcode may need to be overwritten, equals is already done if itm
    // keeps being an issue
    // TODO uncomment this if needed later on
    // @Override
    // public int hashCode() {
    // return Objects.hash(title, artist, album); // Include all fields used in
    // equals()
    // }
